\hypertarget{class_q_c_p_color_map}{}\doxysection{Q\+C\+P\+Color\+Map Class Reference}
...
Inherits \mbox{\hyperlink{class_q_c_p_abstract_plottable}{Q\+C\+P\+Abstract\+Plottable}}.
...
To show the user which colors correspond to which {\itshape data} values, a \mbox{\hyperlink{class_q_c_p_color_scale}{Q\+C\+P\+Color\+Scale}} is typically placed to the right of the axis rect. See the documentation there for details on how to add and use a color scale.\hypertarget{class_q_c_p_color_map_qcpcolormap-appearance}{}\doxysubsection{Changing the appearance}\label{class_q_c_p_color_map_qcpcolormap-appearance}
